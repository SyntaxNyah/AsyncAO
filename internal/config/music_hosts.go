...
// urlHost extracts a /play link's lowercased host (no port), or "" if it isn't a
// real URL (a bare server-music name has no host and is never recorded).
