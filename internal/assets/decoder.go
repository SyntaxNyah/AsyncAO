...
const (
	...
	// invisible characters. Decoders DECIMATE to the frames that fit (see
	// frameDecimator): the whole clip plays at a lower frame rate, which
	// beats a sprite that snaps a quarter of the way through.
