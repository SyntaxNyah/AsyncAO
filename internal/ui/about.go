...
var aboutBlocks = []aboutBlock{
	...
	{abAccent, "Special thanks to Nightingale, ZeitHeld and Crystalwarrior — an enormous share of the v1.0.x quality-of-life polish and bug fixes came straight from their relentless, detailed playtesting and issue reports. Go show them some love."},
